...
// # define PTR_B_1 "%p", &ret
// # define PTR_B_2 "%p", (void *)-1
...
# define D_INT_B_1 "%+ 020d", INT_MAX
# define D_INT_B_2 "%+ 020d", INT_MIN
# define D_INT_B_3 "%+ 020.19d", INT_MAX
# define D_INT_B_4 "%+ 020.19d", INT_MIN
...
# define LOWER_X_B_1 "%#x", 0
# define LOWER_X_B_2 "%#x", -1
# define LOWER_X_B_3 "%#x", -42
# define LOWER_X_B_4 "%#-020.19x", (unsigned int)-1
# define LOWER_X_B_5 "%#020.19x", (unsigned int)-1
# define LOWER_X_B_6 "%#-020x", (unsigned int)-1
# define LOWER_X_B_7 "%#020x", (unsigned int)-1
...
# define UPPER_X_B_1 "%#X", 0
# define UPPER_X_B_2 "%#X", -1
# define UPPER_X_B_3 "%#X", -42
# define UPPER_X_B_4 "%#-020.19x", (unsigned int)-1
# define UPPER_X_B_5 "%#020.19x", (unsigned int)-1
# define UPPER_X_B_6 "%#-020x", (unsigned int)-1
# define UPPER_X_B_7 "%#020x", (unsigned int)-1
